...
// Package ux is a pure Go UXres driver for the database/sql package.
// This module contains support for UXres LISTEN/NOTIFY.
...
type Notification struct {
	// Process ID (PID) of the notifying UXres backend.
	BePid int
...
// connection. A runtime panic occurs if c is not a ux connection. A nil handler
// may be used to unset it.
//
// Note: Notification handlers are executed synchronously by ux meaning commands
...
var errListenerConnClosed = errors.New("ux: ListenerConn has been closed")
...
// Main logic is here: receive messages from the UXres backend, forward
...
var errListenerClosed = errors.New("ux: Listener has been closed")
...
const (
	...
	// nil ux.Notification is sent on the Listener.Notify channel.
...
// UXSQL database.  For general usage information, see section
// "Notifications".
//
...
//   2) The query was executed on the remote server, but UXSQL returned an
//      error message in response to the query.  The returned error will be a
//      ux.Error containing the information the server supplied.
...
func (l *Listener) Unlisten(channel string) error {
	...
	// Similarly to LISTEN, this is not an error in UXres, but it seems

// Package ux is a pure Go Postgres driver for the database/sql package.
package uxgo
...
// Perform Windows user name lookup identically to libux.
//
// The UXSQL code makes use of the legacy Win32 function
